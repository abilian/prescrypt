...
def spam(a=1, b=1, *, c=1, d=1):
    pass


def spam(a, b=1, *, c, d=1):
    pass
...
class Foo(base1, base2, metaclass=mymeta, foo=True):
    pass


class Foo(base1, base2, metaclass=mymeta, **foo):
    pass
