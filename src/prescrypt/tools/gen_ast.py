...
TYPES = {
    ...
    "AsyncFunctionDef.name": "ellipsis",
    ...
    "ClassDef.name": "ellipsis",
    "Compare.comparators": "list[expr]",
    "Compare.left": "expr",
    "Compare.ops": "list[cmpop]",
    "Constant.kind": "None | ellipsis",
    "Constant.value": "None | bytes | complex | ellipsis | " "float | int",
    ...
    "ExceptHandler.name": "None | ellipsis",
    ...
    "ImportFrom.module": "None | ellipsis",
    ...
    "Match.subject": "expr",
    "MatchAs.name": "None | ellipsis",
    "MatchAs.pattern": "None",
    "MatchClass.cls": "expr",
    "MatchClass.kwd_attrs": "list[ellipsis]",
