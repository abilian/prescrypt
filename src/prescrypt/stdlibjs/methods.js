// method: append
export const append = function (x) { // nargs: 1
...
// method: extend
export const extend = function (x) { // nargs: 1
    if (!Array.isArray(this)) return this.KEY.apply(this, arguments);
...
// method: insert
export const insert = function (i, x) { // nargs: 2
    if (!Array.isArray(this)) return this.KEY.apply(this, arguments);
...
// method: remove
export const remove = function (x) { // nargs: 1
    if (!Array.isArray(this)) return this.KEY.apply(this, arguments);
...
// method: reverse
export const reverse = function () { // nargs: 0
    this.reverse();
};
...
// method: sort
export const sort = function (key, reverse) { // nargs: 0 1 2
    if (!Array.isArray(this)) return this.KEY.apply(this, arguments);
...
// method: clear
export const clear = function () { // nargs: 0
...
// method: copy
export const copy = function () { // nargs: 0
    if (Array.isArray(this)) {
        return this.slice(0);
    } else if (this.constructor === Object) {
...
// method: pop
export const pop = function (i, d) { // nargs: 1 2
    if (Array.isArray(this)) {
        i = (i === undefined) ? -1 : i;
        i = (i < 0) ? (this.length + i) : i;
...
// method: count
export const count = function (x, start, stop) { // nargs: 1 2 3
...
// method: index
export const index = function (x, start, stop) { // nargs: 1 2 3
    start = (start === undefined) ? 0 : start;
    stop = (stop === undefined) ? this.length : stop;
    start = Math.max(0, ((start < 0) ? this.length + start : start));
    stop = Math.min(this.length, ((stop < 0) ? this.length + stop : stop));
...
// method: get
export const get = function (key, d) { // nargs: 1 2
...
// method: items
export const items = function () { // nargs: 0
    if (this.constructor !== Object) return this.KEY.apply(this, arguments);
    var key, keys = Object.keys(this), res = []
...
// method: keys
export const keys = function () { // nargs: 0
...
// method: popitem
export const popitem = function () { // nargs: 0
    if (this.constructor !== Object) return this.KEY.apply(this, arguments);
    var keys, key, val;
...
// method: setdefault
export const setdefault = function (key, d) { // nargs: 1 2
    if (this.constructor !== Object) return this.KEY.apply(this, arguments);
    if (this[key] !== undefined) {return this[key];}
...
// method: update
export const update = function (other) { // nargs: 1
    if (this.constructor !== Object) return this.KEY.apply(this, arguments);
...
// method: values
export const values = function () { // nargs: 0
    if (this.constructor !== Object) return this.KEY.apply(this, arguments);
    var key, keys = Object.keys(this), res = [];
...
// method: repeat
export const repeat = function(count) { // nargs: 0
...
// method: capitalize
export const capitalize = function () { // nargs: 0
...
// method: casefold
export const casefold = function () { // nargs: 0
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: center
export const center = function (w, fill) { // nargs: 1 2
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: endswith
export const endswith = function (x) { // nargs: 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: expandtabs
export const expandtabs = function (tabsize) { // nargs: 0 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: find
export const find = function (x, start, stop) { // nargs: 1 2 3
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    start = (start === undefined) ? 0 : start;
    stop = (stop === undefined) ? this.length : stop;
    start = Math.max(0, ((start < 0) ? this.length + start : start));
...
// method: isalnum
export const isalnum = function () { // nargs: 0
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: isalpha
export const isalpha = function () { // nargs: 0
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: partition
export const partition = function (sep) { // nargs: 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: replace
export const replace = function (s1, s2, count) {  // nargs: 2 3
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    var i = 0, i2, parts = [];
...
// method: rfind
export const rfind = function (x, start, stop) { // nargs: 1 2 3
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    start = (start === undefined) ? 0 : start;
    stop = (stop === undefined) ? this.length : stop;
    start = Math.max(0, ((start < 0) ? this.length + start : start));
...
// method: rindex
export const rindex = function (x, start, stop) {  // nargs: 1 2 3
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: rjust
export const rjust = function (w, fill) { // nargs: 1 2
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    fill = (fill === undefined) ? ' ' : fill;
    var tofill = Math.max(0, w - this.length);
...
// method: rpartition
export const rpartition = function (sep) { // nargs: 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    if (sep === '') {var e = Error('empty sep'); e.name='ValueError'; throw e;}
...
// method: rsplit
export const rsplit = function (sep, count) { // nargs: 1 2
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: rstrip
export const rstrip = function (chars) { // nargs: 0 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    chars = (chars === undefined) ? ' \t\r\n' : chars;
...
// method: split
export const split = function (sep, count) { // nargs: 0, 1 2
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    if (sep === '') {var e = Error('empty sep'); e.name='ValueError'; throw e;}
    sep = (sep === undefined) ? /\s/ : sep;
...
// method: splitlines
export const splitlines = function (keepends) { // nargs: 0 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: startswith
export const startswith = function (x) { // nargs: 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: strip
export const strip = function (chars) { // nargs: 0 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    chars = (chars === undefined) ? ' \t\r\n' : chars;
    var i, s1 = this, s2 = '', s3 = '';
...
// method: swapcase
export const swapcase = function () { // nargs: 0
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    var c, res = [];
    for (var i=0; i<this.length; i++) {
        c = this[i];
...
// method: title
export const title = function () { // nargs: 0
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
...
// method: translate
export const translate = function (table) { // nargs: 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
    var c, res = [];
    for (var i=0; i<this.length; i++) {
        c = table[this[i]];
...
// method: zfill
export const zfill = function (width) { // nargs: 1
    if (this.constructor !== String) return this.KEY.apply(this, arguments);
